...
const routes = [
    ...
    {
        path: 'course',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_tabs_course_course_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./tabs/course/course.module */ 1485)).then(m => m.CoursePageModule)
    },
    {
        path: '',
